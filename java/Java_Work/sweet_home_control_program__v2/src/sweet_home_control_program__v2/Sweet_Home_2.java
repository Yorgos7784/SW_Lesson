...
public class Sweet_Home_2 {
	...
	public static void adminProcess(SerialPort serial, Scanner s) {
	...
	public static void guestProcess(SerialPort serial, Scanner s) {
	...
	public static void main(String[] args) {
		...
		while(true) {
			...
			if (mode.equals(ADMIN_MODE))
				adminProcess(serial, s);
			else if (mode.equals(GUEST_MODE))
				guestProcess(serial, s);
